...
public class Implicit3D : MonoBehaviour
{
    ...
    public Scheme SelectAScene;
    
    void Start()
    {
        switch(SelectAScene)
        {
            case Scheme.Custom:break;
            case Scheme.RigidCubeLowResolution:
                {
                    fileName = "cubeLow";
                    invmass = 1;
                    dt = 0.1f;
            ...
            case Scheme.SoftCubeLowResolution:
                {
                    fileName = "cubeLow";
                    invmass = 1;
                    dt = 0.1f;
            ...
            case Scheme.RigidCubeMedResolution:
                {
                    fileName = "cubeMed";
                    invmass = 1;
                    dt = 0.1f;
            ...
            case Scheme.SoftCubeMedResolution:
                {
                    fileName = "cubeMed";
                    invmass = 5;
                    dt = 0.1f;
            ...
            case Scheme.RigidCubeHighResolution:
                {
                    fileName = "cubeHigh";
                    invmass = 10;
                    dt = 0.1f;
            ...
            case Scheme.SoftCubeHighResolution:
                {
                    fileName = "cubeHigh";
                    invmass = 10;
                    dt = 0.1f;
            ...
            case Scheme.CreeperLowResolution:
                {
                    fileName = "creeperLow";
                    invmass = 1;
                    dt = 0.1f;
            ...
            case Scheme.CreeperMedResolution:
                {
                    fileName = "creeperMed";
                    invmass = 1;
                    dt = 0.1f;
            ...
            case Scheme.CreeperHighResoultion:
                {
    ...
    void Step()
    {
        ...
        stepCompute.Dispatch(kernel, elem_num / ELE_WARP_SIZE + 1, 1, 1);
