...
public:
	...
	int Relative(int idx0, int idx1)
	{
		...
		*/
		int res = idx1 - idx0;
		if (res == 0)return 0;
		else if (res == -Nx - 1)return 1;
		else if (res == -Nx)return 2;
		else if (res == -Nx + 1)return 3;
		else if (res == -1)return 4;
		else if (res == 1)return 5;
		else if (res == Nx - 1)return 6;
		else if (res == Nx)return 7;
		else if (res == Nx + 1)return 8;
		return 0;
	}
