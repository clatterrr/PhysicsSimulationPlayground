...
vt0 = np.zeros((3,3))
vt0[0,:] = computeEigenVector(AtA0 - np.identity(3)*abs(s0[0]*s0[0]),0)
vt0[1,:] = computeEigenVector(AtA0 - np.identity(3)*abs(s0[1]*s0[1]),1)
vt0[2,:] = computeEigenVector(AtA0 - np.identity(3)*abs(s0[2]*s0[2]),2)
